...
def _get_args(enable_dyn1: bool = False, enable_dyn2: bool = False, disable_dyn3: bool = False) -> argparse.Namespace:
...
def test_dyn2_enabled_dyn3_disabled(temp_dir):
    docker_compose_utils._set_dynamic_options(_get_args(enable_dyn2=True, disable_dyn3=True))
    assert _get_env_lines(temp_dir) == [
        'ENV_VAR1=val1',
        'DYNAMIC1_BOTH=disabled',
        'DYNAMIC1_DISABLED=disabled',
